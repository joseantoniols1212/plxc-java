...
public class ForDownToNode extends SentenceNode {
    ...
    public ForDownToNode(AssignmentNode initialization, ExpressionNode bound, ExpressionNode step, SentenceNode body) {
    ...
    public ForDownToNode(AssignmentNode initialization, ExpressionNode bound, SentenceNode body) {
        this.initialization = initialization;
        this.bound = bound;
